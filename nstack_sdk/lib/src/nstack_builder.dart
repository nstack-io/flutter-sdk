...
/// A builder which outputs a 'nstack_cli.dart' file. This file provides a NStack instance, type safe section key accessors and all bundled translations.
...
import 'package:nstack_api/entities/localize_language.dart';
import 'package:nstack_api/entities/config.dart';
import 'package:nstack_sdk/nstack_cli.dart';
...
const _config = NStackConfig(projectId: '$projectId', apiKey: '$apiKey');
  ...
  void _writeLanguageList(List<LocalizeIndex> languages, StringBuffer output) {
    ...
    languages.forEach((localizeIndex) {
      LocalizeLanguage language = localizeIndex.language;
      output.writeln(
