...
class NstackBuilder implements Builder {
  ...
  void _writeHeader(StringBuffer output) {
    ...
    output.writeln("import 'package:nstack/partial/localization_fromjson.dart';");
  ...
  void _writeLocalization(String response, StringBuffer output) {
    ...
    output.writeln("class Localization extends LocalizationRootNode {");
    ...
    output.writeln("\tLocalization fromJson(dynamic json) {");
